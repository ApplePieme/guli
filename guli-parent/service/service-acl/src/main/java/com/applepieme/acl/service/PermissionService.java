package com.applepieme.acl.service;
...
public interface PermissionService extends IService<Permission> {
    ...
    /* ==================================applepieme===================================================== */
    // 获取全部菜单 applepieme
    List<Permission> queryAllMenuApple();

    // 递归删除菜单 applepieme
    boolean removeChildByIdApple(String id);

    boolean createRolePermissionRealtionApple(String roleId, String[] permissionIds);
}
